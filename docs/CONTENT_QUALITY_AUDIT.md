...
**8,254 rows**, one per reachable Korean item.
...
|:---|---:|
| level test | 4,049 |
| word card example sentence | 3,393 |
| daily vocabulary / review gap-fill | 513 |
| numbers | 299 |
...
|:---|:---|:---|---:|:---|:---|:---|:---|:---|:---|
| Word card example sentences | content/vocabulary/entries/*.jsonl | apps/web/public/corpus/band-*.json | 3393 | example | 1–30 | 32 | word cards, Today’s Vocabulary, Review | gated | read 2026-09-10 |
| Level test — meaning | content-cache/level-test-anchors.json | public/level-test/bank-8b0e5dba.json | 1761 | meaning | 1–30 | 32 | Vocabulary Level Test | gated | gates only |
| Level test — produce | content-cache/level-test-anchors.json | public/level-test/bank-8b0e5dba.json | 1761 | produce | 1–30 | 32 | Vocabulary Level Test | gated | gates only |
| Level test — context | content/vocabulary/entries/*.jsonl | public/level-test/bank-8b0e5dba.json | 473 | gap-fill | 3–30 | 32 | Vocabulary Level Test | gated | every item read 2026-09-10 |
| Daily / review gap-fills | content/vocabulary/entries/*.jsonl | src/data/generated/cloze.json | 513 | gap-fill | 3–30 | 32 | Today’s Vocabulary, Review | gated | same items as above |
...
| Hand-written contextual items | content/vocabulary/context-items.json | public/level-test/bank-8b0e5dba.json | 22 | gap-fill | 1–5 | 32 | Vocabulary Level Test, Today’s Vocabulary, Review | validated by the builder against the generated items’ own rules | authored and read 2026-09-10 |
...
| Dictionary senses | content-cache (Wiktionary) | public/dictionary/* | 39628 | reference | n/a | en only | Search | gated | never scheduled; not taught |
