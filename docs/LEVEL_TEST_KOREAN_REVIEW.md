...
| Learner safety, words | safety | 3,370 taught words, 29,711 dictionary headwords, 3,990 bank items with their meanings in 32 languages, 510 gap-fills, letters, UI copy, Numbers, quotations, curriculum export, 6,952 audio transcripts — 1,001,715 fields | all | the child-safe content policy 1.0.0 (7 categories, surface forms in 32 languages, romanisations, context rules, gloss indicators), matched as lexemes with inflection, particle, spacing and evasion handling; 355 shared fixtures through two evaluators. Replaced the 66-term whole-headword list that passed 섹스하다 | gate | 2026-09-11 |
| Learner safety, sentences | safety | 1,880 contextual + 2,040 gap-fill compositions | all | 6 frame rules over 236 classified nouns, run on the composed sentence, and the policy's context rules on every composed sentence at build time | gate | 2026-09-11 |
