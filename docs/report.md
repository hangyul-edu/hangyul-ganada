...
| Tests | 1,289 across 73 files | `npm test` |
...
| | |
| --- | --- |
| Unit and integration tests | **1,289 across 73 files** — handwriting-core 96, korean-morphology 216, web 976 (57 of them the Numbers journeys, negative tests, migration fixtures and exercise-engine tests of §20K) |
...
The suites run green in full: 1,289 unit cases across three packages — 976
