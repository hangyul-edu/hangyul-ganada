...
both delivery manifests at HEAD. Of the nine issues not marked resolved, none
is a defect in this code or content: four are content authoring at a scale this
pass could not reach (I-04, I-19, I-20, I-79), two need a speaker of each
language (I-17, I-39), one needs a value that only the product's owner has
(I-03), one needs a spoken-Korean frequency corpus that does not exist as open
data (I-126), and one is a deliberate refusal to invent data (I-13).
...
**Blocked outside this repository: 1 · Partial: 4 · Resolved: 147**
