...
| `npm run audio:qa` | Check all 13,974 voice slots over 13,854 files |
...
| `npm run audio:qa` | All 13,974 voice slots over 13,854 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
