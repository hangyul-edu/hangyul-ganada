...
| `npm run audio:qa` | Check all 13,904 voice slots over 13,784 files |
...
| `npm run audio:qa` | All 13,904 voice slots over 13,784 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
