...
| `npm run audio:qa` | Check all 13,562 voice slots over 13,458 files |
...
| `npm run audio:qa` | All 13,562 voice slots over 13,458 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
