...
| `npm run audio:qa` | Check all 13,996 voice slots over 13,876 files |
...
| `npm run audio:qa` | All 13,996 voice slots over 13,876 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
