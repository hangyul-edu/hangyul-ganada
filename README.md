...
| `npm run audio:qa` | Check all 13,980 voice slots over 13,860 files |
...
| `npm run audio:qa` | All 13,980 voice slots over 13,860 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
