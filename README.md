...
| `npm run audio:qa` | Check all 13,728 voice slots over 13,608 files |
...
| `npm run audio:qa` | All 13,728 voice slots over 13,608 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
