...
| `npm run audio:qa` | Check all 15,948 voice slots over 15,828 files |
...
| `npm run audio:qa` | All 15,948 voice slots over 15,828 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
