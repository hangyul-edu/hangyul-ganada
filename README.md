...
| `npm run audio:qa` | Check all 11,890 voice slots over 11,788 files |
...
| `npm run audio:qa` | All 11,890 voice slots over 11,788 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
