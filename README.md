...
| `npm run audio:qa` | Check all 12,018 voice slots over 11,916 files |
...
| `npm run audio:qa` | All 12,018 voice slots over 11,916 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
