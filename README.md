...
| Vocabulary | 3,334 words across 18 semantic categories, all open from the start |
...
apps/
  web/                 Vite + React + TypeScript. The product.
    ...
    public/audio/        15,840 pronunciation clips and their manifest
...
| `npm run audio:qa` | Check all 15,960 voice slots over 15,840 files |
...
The bundled vocabulary is **3,334 words**, hand-reviewed, using English
...
| `npm run audio:qa` | All 15,960 voice slots over 15,840 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
...
curriculum, 3,334 words, bundled pronunciation in two voices, offline support
