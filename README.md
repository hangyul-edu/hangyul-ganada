...
| `npm run audio:qa` | Check all 13,740 voice slots over 13,620 files |
...
| `npm run audio:qa` | All 13,740 voice slots over 13,620 files: decode, duration, loudness, voice distinctness, manifest and rate agreement |
