...
const LESSON_SPECS: LessonSpec[] = [
  {
    ...
    titles: {
      ...
      de: { title: "Sechs Vokale zum Anfang" },
  ...
  },
  {
    ...
    titles: {
      ...
      ko: { title: "받침이 있는 글자" },
      ja: { title: "文字の足もとの子音" },
      'zh-CN': { title: "落在字底的那个字母" },
      es: { title: "Una letra al pie" },
      fr: { title: "Une lettre au pied du bloc" },
      de: { title: "Ein Buchstabe am Fuß" },
      'pt-BR': { title: "Uma letra no pé do bloco" },
