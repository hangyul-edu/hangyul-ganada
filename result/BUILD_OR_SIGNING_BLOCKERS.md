...
Re-checked on 8 September 2026 against **v1.0.4, versionCode 17**, compiled
...
machine. The Android artefacts were rebuilt at versionCode 17 and signed with
...
Android ships this release as 1.0.4, versionCode 17. iOS does not, and its
...
1. Open `apps/mobile/ios/App/App.xcodeproj`, select the **App** target, and set
   **Version** to `1.0.4` and **Build** to `17` for both Debug and Release.
2. Update `ios.xcode.marketingVersion` to `"1.0.4"` and
