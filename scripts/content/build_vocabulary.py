...
from hangul import CURRICULUM_ORDER, is_hangul_word, romanize, syllables  # noqa: E402
        ...
        records.append(
            {
                ...
                # `pronunciation.py`.
                **(
                    {"say": sound_note[0], "sayWhy": sound_note[1]}
                    if (sound_note := pronunciation.note_for(word))
                    else {}
                ),
