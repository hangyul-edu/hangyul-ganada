...
Built from commit `384c245efd9e6ddb17c1347e7d3dd109fe7f295c` at 2026-09-18T08:38:31.636Z.
...
| --- | --- | --- |
| `hangyul-ganada-release.apk` | 98.7 MB | sideloading, and testing on a device |
| `hangyul-ganada-release.aab` | 96.6 MB | the upload to Google Play |
...
`com.talkhangyul.ganada`, version 1.0.5 (26), min SDK
24, target SDK 36.
