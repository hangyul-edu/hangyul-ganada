...
Built from commit `cead31d4359b7d4641eb9ff3ff7600254261eb5f` at 2026-08-21T22:18:03.910Z.
...
| --- | --- | --- |
| `hangyul-ganada-release.apk` | 66.0 MB | sideloading, and testing on a device |
| `hangyul-ganada-release.aab` | 64.8 MB | the upload to Google Play |
...
`com.talkhangyul.ganada`, version 1.0.0 (1), min SDK
24, target SDK 36.
