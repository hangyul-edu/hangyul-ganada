...
Built from commit `e5436cc2bb7e5cc88804a8ead621d4b54e1ead0a` at 2026-09-09T06:44:21.163Z.
...
| --- | --- | --- |
| `hangyul-ganada-release.apk` | 86.9 MB | sideloading, and testing on a device |
| `hangyul-ganada-release.aab` | 85.1 MB | the upload to Google Play |
...
`com.talkhangyul.ganada`, version 1.0.5 (21), min SDK
24, target SDK 36.
