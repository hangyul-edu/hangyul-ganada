...
Built from commit `8130a081b3ae6f3e053e3198b557ec5b622e5c40` at 2026-09-11T18:28:42.953Z.
...
| --- | --- | --- |
| `hangyul-ganada-release.apk` | 86.4 MB | sideloading, and testing on a device |
| `hangyul-ganada-release.aab` | 84.6 MB | the upload to Google Play |
...
`com.talkhangyul.ganada`, version 1.0.4 (25), min SDK
24, target SDK 36.
